...
RAY_CHECK_ENUM(protocol::MessageType::SubmitTask, MessageType::SubmitTask);
RAY_CHECK_ENUM(protocol::MessageType::TaskDone, MessageType::TaskDone);
RAY_CHECK_ENUM(protocol::MessageType::EventLogMessage, MessageType::EventLogMessage);
...
RAY_CHECK_ENUM(protocol::MessageType::RegisterClientReply,
               MessageType::RegisterClientReply);
RAY_CHECK_ENUM(protocol::MessageType::DisconnectClient, MessageType::DisconnectClient);
RAY_CHECK_ENUM(protocol::MessageType::GetTask, MessageType::GetTask);
RAY_CHECK_ENUM(protocol::MessageType::ExecuteTask, MessageType::ExecuteTask);
RAY_CHECK_ENUM(protocol::MessageType::ReconstructObject, MessageType::ReconstructObject);
RAY_CHECK_ENUM(protocol::MessageType::NotifyUnblocked, MessageType::NotifyUnblocked);
RAY_CHECK_ENUM(protocol::MessageType::PutObject, MessageType::PutObject);
RAY_CHECK_ENUM(protocol::MessageType::GetActorFrontierRequest,
               MessageType::GetActorFrontierRequest);
RAY_CHECK_ENUM(protocol::MessageType::GetActorFrontierReply,
               MessageType::GetActorFrontierReply);
RAY_CHECK_ENUM(protocol::MessageType::SetActorFrontier, MessageType::SetActorFrontier);
